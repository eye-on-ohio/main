...
Update: As per the auditor, railroads are actually taxed at the state level. But you get the gist.
...
#rio::export(Commercial_Properties, "Franklin County Properties to Verify 8-10-19.csv")
...
```{r}
#Uncomment this to import
#Commercial_Properties <- rio::import("Franklin County Properties Last Verified 8-10-19.xlsx")
```
...
Yeah we are still verifying this. 
